...
rtl_fm -l $squelch -f "$freq"M -M wbfm -g 50 -s 12.5k -r 12.5k | ffmpeg -re -f lavfi -i testsrc=duration=$timeout:size=480x360:rate=30 -f s16le -ac 1 -ar 12.5k -i pipe:0 -vcodec libx264 -preset veryfast -maxrate 1984k -bufsize 3968k -vf "format=yuv420p" -g 60  -acodec libmp3lame -b:a 96k -ar 11025 -f flv -s 480x360 rtmp://a.rtmp.youtube.com/live2/$rtmpkey &
